...
public class Game1b extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_game1b, container, false);
        ...
        //Glide.with(getContext()).load(R.drawable.gameinstuctions2).into(background_image_view);
